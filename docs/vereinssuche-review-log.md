...
- Öffentliche VS-0.7.5-Verifikation nach dem folgenden Push: noch auszuführen; priorisiert `TC Weiden Köln`, `Tennisclub Blau Weiß Zündorf`, `Tennisclub Rot Weiss Porz`, Browser und vollständige Reviewer-Matrix.

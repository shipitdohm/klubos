...
- Öffentliche VS-0.7.3-Verifikation nach Push `de6d242`: Seite lieferte `data-version="VS-0.7.3-official-alias-safe"`; dabei blieb `Tennisclub Blau Weiß Zündorf` noch OSM. Dieser Befund wurde vor dem finalen VS-0.7.4-Gate behoben. Öffentliche VS-0.7.4-Verifikation nach dem folgenden Push ist noch auszuführen.

...
- Nächster Schritt: Commit und Push als VS-0.7.6; öffentliche API-Regressionsprobe für `TC Kirchhorde`, `Tennisclub Kirchhorde`, `TC Augsburg e.V.`, `Tennisclub Augsburg e.V.`, `TC Augsburg Augsburg` sowie die bisherigen offiziellen/ambiguous/no-result Fälle; anschließend unabhängiger 32+100-Gate.

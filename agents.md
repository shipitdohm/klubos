...
- **Logo:** use `assets/klubos-logo-long-black.png` as the primary supplied lockup and `assets/klubos-logo-long-white.png` on dark or terracotta surfaces. Use `assets/klubos-favicon.png` for favicon and compact app contexts. These are the exact supplied, background-free source artworks; do not recreate, redraw, retype, recolor, or introduce a competing logo.
